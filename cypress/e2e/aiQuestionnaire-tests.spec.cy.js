...
describe('AI Security Questionnaire - Complex Business Logic Validation for US,EU,APAC regions', () => {
    ...
    it(`E2E Test for ${data.region} Region: validate each section using valid inputs * sensitiveData : ${data.sensitiveData} ,riskLevel: ${data.riskLevel}, 
        ...
        riskAssessment: ${data.riskAssessment},audit: ${data.audit}` , function () {   
   ...
   describe.skip('Compliance Measures Page - Missing field validations', () => {
    ...
    // Catch errors globally so they won't fail the entire test
/*Cypress.on('fail', (error, runnable) => {
  console.error('Test failed, but continuing with next test.');
